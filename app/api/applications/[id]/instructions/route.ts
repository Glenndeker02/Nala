    ...
    async (
        ...
        try {
            ...
            return ApiResponse.success({
                instructions: application.acceptanceInstructions, // Legacy field, keep for compatibility
                overallInstructions: application.overallInstructions,
                videoInstructions: application.videoInstructions,
                instructionDeadlines: application.instructionDeadlines,
                instructionLinks: application.instructionLinks,
                instructionLibraryItems: application.instructionLibraryItems,
