        ...
        try {
            ...
            if (response.ok) {
                ...
                setStats({
                    ...
                    approvedVideos,
                    totalViews,
                    budgetSpent: (campaignData.videosCompleted || 0) * (campaignData.baseFeePerVideo || 0)
                });
            }
        } catch (error) {
                ...
                <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                        ...
                        <TabsContent value="overview">
                            {/* Campaign Status & Lock-In Section */}
                            <Card className="mb-8 !bg-green-100 !border-green-200 shadow-sm">
